...
describe('RSIConfigNetwork', () => {
    ...
    let provider = NeuralNetService_1.NeuralNetService.getDefaultProvider();
    const rsiConfigNetwork = new RSIConfigNetwork_1.RSIConfigNetwork(provider, new Market_1.Market('GDAX', 'BTC', 'USD'));
